...
import { TCategoria, TMeta } from "../interfaces/interfaces"
...
const upload_cover=async(e:any)=>{
    ...
    form.append('cover',e)
    const request = await fetch(`${process.env.API}/covers`,{
        method:'post',
        body:form
    })
...
export const NewPost = ({tipos,categorias}:Params) => {
